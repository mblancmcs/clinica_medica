...
public class SecurityConfiguration implements WebMvcConfigurer {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.cors(Customizer.withDefaults())
                .csrf(csrf -> csrf.disable())// desabilitando, pois o proprio token ja protege contra esse ataque
                ...
                .authorizeHttpRequests(req -> { // metodo para configurar como vai ser a configuracao das requisicoes
                    ...
                    req.requestMatchers(HttpMethod.PUT, "/auth/atualizar").hasRole("ADMIN");
